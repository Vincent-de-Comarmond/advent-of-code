...
void stuck_on(int gridsize, char grid[gridsize][gridsize]) {
  int max = gridsize - 1;

  grid[0][0] = '#', grid[0][max] = '#', grid[max][0] = '#',
  grid[max][max] = '#';
}
...
// 1005 is too low for part 2
// 1006 is the right answer for part 2
// Execution time: 0.026281 seconds
